...
export const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const endpoint = ENDPOINTS.ACCOUNTS.REGISTER; 
        try{
    ...
    return (
        <div className="w-100 p-2 mx-auto" style={{height:"90vh", 
            ...
            >
                    ...
                    <Form.Control  name="password1" required placeholder="Password" type="password" />
                    <Form.Control  name="password2" required placeholder="Retype Password" type="password" />
                    <Form.Text className='text-danger px-1 my-0' >{err}</Form.Text>
                    <Button className='rounded-5' type="submit">
                     Submit 
                    </Button>
                    <Button variant='secondary' href='/accounts/login' className='rounded-5' type="submit">
                     Login
                    </Button>
